  ...
  return (
    <div className="text-white min-h-screen font-sans selection:bg-purple-500 selection:text-white overflow-x-hidden md:cursor-none cursor-auto relative">
      ...
      <main className="relative z-20">
        ...
        {/* HERO */}
        <section ref={heroRef} className="relative z-10 min-h-[100dvh] flex flex-col items-center justify-center px-6 text-center pt-32 pb-24 md:py-24">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-12 mb-24">
            ...
            <button
              ...
              className="group relative flex items-center gap-3 font-['Work_Sans',sans-serif] text-[10px] md:text-xs font-medium uppercase tracking-widest text-white py-2.5 px-6 md:py-2 md:px-0 bg-white/5 md:bg-transparent rounded-full md:rounded-none border border-white/10 md:border-none"
            >
              ...
              <Play
                className="w-3 h-3 fill-current md:hidden"
              />
            ...
            <a
              ...
              onMouseEnter={textEnter}
              onMouseLeave={textLeave}
              className="group relative font-['Work_Sans',sans-serif] text-[10px] md:text-xs font-medium uppercase tracking-widest text-white transition-colors duration-300 py-2.5 px-6 md:py-2 md:px-0 bg-white/5 md:bg-transparent rounded-full md:rounded-none border border-white/10 md:border-none"
            >
              About Me
              {/* Underline Animation */}
              <span className="absolute bottom-1 right-0 w-0 h-[1px] bg-white opacity-0 group-hover:opacity-100 transition-all duration-500 ease-[cubic-bezier(0.19,1,0.22,1)] group-hover:w-full group-hover:left-0"></span>
